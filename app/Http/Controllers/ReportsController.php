...
class ReportsController extends Controller {
	...
	public function booking() {
		$years = collect(DB::select("select distinct year(from_date) as years from bookings where deleted_at is null order by years desc"));
		...
		$data['year_select'] = date("Y");
		$data['month_select'] = date("n");
		$data['bookings'] = Bookings::whereMonth("from_date", date("n"))->whereMonth("from_date", date("n"))->get();
		$data['vehicles'] = VehicleModel::get();
	...
	public function booking_post(Request $request) {
		...
		$data['bookings'] = Bookings::whereMonth("from_date", $data['month_select'])->whereMonth("from_date", $data['month_select']);
