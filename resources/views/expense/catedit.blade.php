...
{!! Form::open(['route' => ['expensecategories.update',$data->id],'method'=>'PATCH']) !!}
{!! Form::hidden('id',$data->id) !!}
 ...
 {!! Form::select('frequancy', ['Daily' => 'Daily', 'Weekly' => 'Weekly','Monthly'=>'Monthly','Quarterly'=>"Quarterly",'Yearly'=>'Yearly'], $data->frequancy,['class'=>'form-control']); !!}
 </div>
 <div class="form-group">
 {!! Form::label('cost', __('fleet.expenseCost'), ['class' => 'form-label']) !!}
 {!! Form::number('cost', $data->cost,['class' => 'form-control','required']) !!}
 </div>
