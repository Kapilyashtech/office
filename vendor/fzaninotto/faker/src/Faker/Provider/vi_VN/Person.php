...
class Person extends \Faker\Provider\Person {
	...
	protected static $firstNameMale = array(
		...
		'Ca', 'Canh', 'Chiến', 'Chiểu', 'Châu', 'Chinh', 'Chương', 'Chưởng', 'Chấn', 'Công', 'Cơ', 'Cương', 'Cường', 'Cảnh', 'Cần', 'Cẩn',
		...
		'Kha', 'Khang', 'Khanh', 'Khiêm', 'Khiếu', 'Khoa', 'Khoát', 'Khánh', 'Khôi', 'Khương', 'Khải', 'Kim', 'Kiên', 'Kiếm', 'Kiện', 'Kiệt', 'Kinh', 'Kỳ', 'Kỷ',
		...
		'Thanh', 'Thiên', 'Thiện', 'Thuận', 'Thành', 'Thái', 'Thông', 'Thúc', 'Thạc', 'Thạch', 'Thắng', 'Thể', 'Thịnh', 'Thọ', 'Thống', 'Thời', 'Thụy', 'Thủy', 'Thực', 'Tiến', 'Tiếp', 'Tiền', 'Tiển', 'Toàn', 'Toại', 'Toản', 'Trang', 'Triết', 'Triều', 'Triệu', 'Trung', 'Trác', 'Tráng', 'Trân', 'Trình', 'Tri', 'Trúc', 'Trường', 'Trưởng', 'Trạch', 'Trọng', 'Trụ', 'Trực', 'Tuyền', 'Tuấn', 'Tuệ', 'Tài', 'Tâm', 'Tân', 'Tin', 'Tùng', 'Tú', 'Tường', 'Tấn', 'Tụ', 'Từ',
		'Uy',
	...
	protected static $middleNameMale = array(
		'An', 'Anh',
		'Bá', 'Bách', 'Bình', 'Bich', 'Bảo', 'Bằng', 'Bửu', 'Bữu',
		'Cao', 'Chiêu', 'Chiến', 'Chung', 'Chuẩn', 'Chánh', 'Chi', 'Chinh', 'Chấn', 'Chế', 'Cát', 'Công', 'Cương', 'Cường', 'Cảnh',
	...
	protected static $lastName = array(
		...
		'Ong',
		'Ông',
		'Phan', 'Phi', 'Phi', 'Phó', 'Phùng', 'Phương', 'Phạm',
		'Quách', 'Quản',
		'Sơn', 'Sử',
