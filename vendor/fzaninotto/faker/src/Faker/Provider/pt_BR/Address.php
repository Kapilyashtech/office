...
class Address extends \Faker\Provider\Address {
	...
	protected static $state = array(
		...
		'Paraná', 'Pernambuco', 'Piaui', 'Rio de Janeiro',
	...
	protected static $country = array(
		...
		'Kiribati', 'Kwait', 'Laos', 'Lesoto', 'Letônia', 'Libéria', 'Libia',
		'Liechtenstein', 'Lituânia', 'Luxemburgo', 'Libano', 'Macedônia',
		'Madagascar', 'Malásia', 'Malaui', 'Maldivas', 'Mali', 'Malta',
		'Marrocos', 'Mauritânia', 'Micronésia', 'Moldávia', 'Mongólia',
		'Montenegro', 'Moçambique', 'México', 'Mônaco', 'Namibia', 'Nauru',
		...
		'Paises Baixos', 'Peru', 'Polônia', 'Portugal', 'Reino Unido',
