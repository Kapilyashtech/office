...
class Person extends \Faker\Provider\Person {
	...
	protected static $firstNameMale = array(
		...
		'Christopher', 'Cristóvão', 'Daniel', 'Dante', 'David', 'Diego', 'Eduardo', 'Elias', 'Emanuel', 'Emiliano', 'Emilio', 'Estêvão',
	...
	protected static $firstNameFemale = array(
		...
		'Ariana', 'Ashley', 'Beatriz', 'Bianca', 'Camila', 'Carla', 'Carolina', 'Catarina', 'Clara', 'Daniela', 'Elizabeth', 'Emilia',
		...
		'Noeli', 'Norma', 'Nádia', 'Olivia', 'Ornela', 'Paula', 'Paulina', 'Pâmela', 'Rafaela', 'Rebeca', 'Regina', 'Renata',
		'Sabrina', 'Salomé', 'Samanta', 'Sara', 'Silvana', 'Sofia', 'Sophie', 'Suzana', 'Tais', 'Tábata', 'Valentina', 'Valéria',
