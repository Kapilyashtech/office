...
class Person extends \Faker\Provider\Person {
	...
	protected static $firstNameMale = array(
		...
		'Leandro', 'Luis', 'Diego', 'Leonardo', 'Alexandre', 'Rúben', 'Mateus', 'Ricardo',
		...
		'Vitor', 'Edgar', 'Kevin', 'Joaquim', 'Igor', 'Ângelo', 'Enzo', 'Valentim', 'Flávio',
	...
	protected static $firstNameFemale = array(
		...
		'Luana', 'Marta', 'iris', 'Alice', 'Bianca', 'Constança', 'Gabriela', 'Eva', 'Clara', 'Bruna', 'Daniela',
		'Iara', 'Filipa', 'Vitória', 'Ariana', 'Leticia', 'Bárbara', 'Camila', 'Rafaela', 'Carlota', 'Yara',
		'Núria', 'Raquel', 'Ema', 'Helena', 'Benedita', 'Érica', 'Isabel', 'Nicole', 'Lia', 'Alicia', 'Mara',
		'Jéssica', 'Soraia', 'Júlia', 'Luna', 'Victória', 'Luisa', 'Teresa', 'Miriam', 'Adriana', 'Melissa',
		...
		'Patricia', 'Vera', 'Doriana', 'Ângela', 'Mia', 'Erica', 'Mónica', 'Isabela', 'Salomé', 'Cátia',
