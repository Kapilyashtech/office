...
class Address extends \Faker\Provider\Address {
	...
	private static $cities = array(
		'Abrantes', 'Agualva-Cacém', 'Águeda', 'Albufeira', 'Alcácer do Sal', 'Alcobaça', 'Almada', 'Almeirim', 'Alverca do Ribatejo', 'Amadora', 'Amarante', 'Amora', 'Anadia', 'Angra do Heroismo', 'Aveiro', 'Barcelos', 'Barreiro',
		...
		'Estremoz', 'Évora', 'Fafe', 'Faro', 'Fátima', 'Felgueiras', 'Fiães', 'Figueira da Foz', 'Freamunde', 'Funchal', 'Fundão', 'Gafanha da Nazaré', 'Gondomar', 'Gouveia', 'Guarda', 'Guimarães', 'Horta', 'ilhavo', 'Lagoa', 'Lagos', 'Lamego',
	...
	protected static $country = array(
		...
		'Bielorrússia', 'Birmânia', 'Bolivia', 'Bósnia e Herzegovina',
		...
		'Hungria', 'india', 'Indonésia', 'Iraque', 'Irlanda', 'Irã',
		'Islândia', 'Ilhas Marshall', 'Ilhas Mauricio', 'Ilhas Salomão',
		'Ilhas Samoa', 'Israel', 'Itália', 'Jamaica', 'Japão', 'Jordânia',
		'Kiribati', 'Kwait', 'Laos', 'Lesoto', 'Letónia', 'Libéria', 'Libia',
		'Liechtenstein', 'Lituânia', 'Luxemburgo', 'Libano', 'Macedónia',
		'Madagascar', 'Malásia', 'Malaui', 'Maldivas', 'Mali', 'Malta',
		'Marrocos', 'Mauritânia', 'Micronésia', 'Moldávia', 'Mongólia',
		'Montenegro', 'Moçambique', 'México', 'Mónaco', 'Namibia', 'Nauru',
		'Nepal', 'Nicarágua', 'Nigéria', 'Noruega', 'Nova Guiné',
		'Nova Zelândia', 'Niger', 'Omã', 'Qatar', 'Quênia', 'Quirguistão',
		'Paquistão', 'Palaos', 'Panamá', 'Papua Nova Guiné', 'Paraguai',
		'Paises Baixos', 'Peru', 'Polónia', 'Portugal', 'Reino Unido',
		...
		'São Vicente e as Granadinas', 'Santa Luzia', 'São Tomé e Principe',
		'Senegal', 'Sérvia', 'Seychelles', 'Serra Leoa', 'Singapura', 'Siria',
		...
		'Tuvalu', 'Tunisia', 'Ucrânia', 'Uganda', 'Uruguai', 'Uzbequistão',
