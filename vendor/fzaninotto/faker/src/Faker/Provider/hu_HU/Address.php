...
class Address extends \Faker\Provider\Address {
	...
	protected static $streetSuffix = array(
		'árok', 'átjáró', 'dűlősor', 'dűlőút', 'erdősor', 'fasor', 'forduló', 'gát', 'határsor', 'határút', 'hid', 'játszótér', 'kert', 'körönd', 'körtér', 'körút', 'köz', 'lakótelep', 'lejáró', 'lejtő', 'lépcső', 'liget', 'mélyút', 'orom', 'országút', 'ösvény', 'park', 'part', 'pincesor', 'rakpart', 'sétány', 'sétaút', 'sor', 'sugárút', 'tér', 'tere', 'turistaút', 'udvar', 'út', 'útja', 'utca', 'üdülőpart',
	);
	...
	protected static $country = array(
		'Afganisztán', 'Albánia', 'Algéria', 'Amerikai Egyesült Államok', 'Andorra', 'Angola', 'Antigua és Barbuda', 'Argentina', 'Ausztria', 'Ausztrália', 'Azerbajdzsán',
		'Bahama-szigetek', 'Bahrein', 'Banglades', 'Barbados', 'Belgium', 'Belize', 'Benin', 'Bhután', 'Bolivia', 'Bosznia-Hercegovina', 'Botswana', 'Brazilia', 'Brunei', 'Bulgária', 'Burkina Faso', 'Burma', 'Burundi',
		...
		'Ecuador', 'Egyenlitői-Guinea', 'Egyesült Arab Emirségek', 'Egyesült Királyság', 'Egyiptom', 'Elefántcsontpart', 'Eritrea', 'Etiópia',
		...
		'Kambodzsa', 'Kamerun', 'Kanada', 'Katar', 'Kazahsztán', 'Kelet-Timor', 'Kenya', 'Kirgizisztán', 'Kiribati', 'Kolumbia', 'Kongói Demokratikus Köztársaság', 'Kongói Köztársaság', 'Kuba', 'Kuvait', 'Kina', 'Közép-Afrika',
		'Laosz', 'Lengyelország', 'Lesotho', 'Lettország', 'Libanon', 'Libéria', 'Liechtenstein', 'Litvánia', 'Luxemburg', 'Libia',
		'Macedónia', 'Madagaszkár', 'Magyarország', 'Malawi', 'Maldiv-szigetek', 'Mali', 'Malájzia', 'Marokkó', 'Marshall-szigetek', 'Mauritánia', 'Mexikó', 'Mikronézia', 'Moldova', 'Monaco', 'Mongólia', 'Montenegró', 'Mozambik', 'Málta',
		'Namibia', 'Nauru', 'Nepál', 'Nicaragua', 'Niger', 'Nigéria', 'Norvégia', 'Németország',
		'Olaszország', 'Omán', 'Oroszország',
		'Pakisztán', 'Palau', 'Panama', 'Paraguay', 'Peru', 'Portugália', 'Pápua Új-Guinea',
		'Románia', 'Ruanda',
		'Saint Kitts és Nevis', 'Saint Vincent', 'Salamon-szigetek', 'Salvador', 'San Marino', 'Seychelle-szigetek', 'Spanyolország', 'Sri Lanka', 'Suriname', 'Svájc', 'Svédország', 'Szamoa', 'Szaúd-Arábia', 'Szenegál', 'Szerbia', 'Szingapúr', 'Szlovákia', 'Szlovénia', 'Szomália', 'Szudán', 'Szváziföld', 'Sziria', 'São Tomé és Principe',
		...
		'Észak-Korea', 'Észtország', 'irország', 'Örményország', 'Új-Zéland', 'Üzbegisztán',
	);
	...
	protected static $smallerCities = array(
		...
		'Nagyatád', 'Nagykálló', 'Nagykáta', 'Nagykőrös', 'Nyiradony', 'Nyirbátor',
