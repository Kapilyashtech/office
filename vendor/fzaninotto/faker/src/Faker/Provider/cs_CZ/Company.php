...
class Company extends \Faker\Provider\Company {
	...
	protected static $noun = array(
		'bezpečnost', 'pohodli', 'seo', 'rychlost', 'testováni', 'údržbu', 'odebiráni', 'výstavbu',
		'návrh', 'prodej', 'nákup', 'zprostředkováni', 'odvoz', 'přepravu', 'pronájem',
	);
	...
	protected static $verb = array(
		'zajišťujeme', 'nabizime', 'děláme', 'provozujeme', 'realizujeme', 'předstihujeme', 'mobilizujeme',
	);
	...
	protected static $attribute = array(
		'pro vás', 'pro vaši službu', 'a jsme jednička na trhu', 'pro lepši svět', 'zdarma', 'se zárukou',
		's inovaci', 'turbiny', 'mrakodrapů', 'lampiónků a sviček', 'bouraci techniky', 'nákupnich košiků',
		'vašeho webu', 'pro vaše zákazniky', 'za nizkou cenu', 'jako jedini na trhu', 'webu', 'internetu',
		'vaši rodiny', 'vašich známých', 'vašich stránek', 'čehokoliv na světě', 'za hubičku',
	);
